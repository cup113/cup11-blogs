...
<img src="./image.png" alt="B站悬停提示示例" style="margin: 20px auto;">
...
<img src="./example.png" alt="Example Image" width="40">
...
3. 请对以下代码进行修改，实现效果图：
   ...
   <img src="./expectation.png" width="300" style="margin: 20px auto;">
