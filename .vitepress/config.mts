    ...
    sidebar: [
      {
        ...
        items: [
          ...
          {
            text: '🌐 B1. Web 通识及工具', link: '/frontend-tutorial/B1', items: [
          ...
          {
            text: '🛡️ C3. TypeScript 基础', link: '/frontend-tutorial/C3', items: [
          ...
          {
            text: '🛡️ D2. Typescript 进阶', link: '/frontend-tutorial/D2', items: [
          ...
          {
            text: '⚙️ D4. 前端原理', link: '/frontend-tutorial/D4', items: [
          ...
          {
            text: '☁️ E1. 服务器基础', link: '/frontend-tutorial/E1', items: [
          ...
          {
            text: '☁️ E2. Express.js 基础', link: '/frontend-tutorial/E2', items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "🧪 深度理解 σ 键和不饱和度的计算", link: '/middle-school/20250503-chemistry-sigma-unsaturate' },
          { text: "📈 组合数学中小球放盒子问题的通解", link: '/middle-school/20250504-math-combinatorial-ball-box' },
        ],
        collapsed: true,
      },
      {
